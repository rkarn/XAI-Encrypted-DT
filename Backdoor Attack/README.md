...
`One mechanism where machine unlearning is used to remedy the backdoor is shown in [https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7163042](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7163042)`.
